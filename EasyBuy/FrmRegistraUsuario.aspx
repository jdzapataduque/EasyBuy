<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmRegistraUsuario.aspx.cs" Inherits="EasyBuy.FrmRegistroUsuario" %>
    ...
    <section id="register">
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtCedula" runat="server" Width="330px"></asp:TextBox>
                    <br />
            ...
            <tr>
                <td class="auto-style4" colspan="2">
                    <asp:Button ID="btnRegistarse" runat="server" Text="Registrarse" Width="165px" OnClick="btnRegistarse_Click" />
